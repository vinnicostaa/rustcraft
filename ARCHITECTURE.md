...
2. Evoluir a interação de bloco de highlight debug para quebrar/colocar bloco.
3. Adicionar mouse look/câmera de primeira pessoa real para melhorar a mira.
